                  ...
                  return (
                    ...
                    >
                      ...
                      {lectures?.map((lecture: any, index: number) => {
                        ...
                        return (
                          <AccordionPanel key={index} backgroundColor={activeLectureID === LectureID ? 'gray.300' : ''} _hover={{backgroundColor: "gray.300"}}>
                            <Flex cursor={"pointer"} columnGap={3} align={"start"} width={"100%"}  >
                              <Checkbox
                                mt={1}
                                iconColor={"black"}
                                size="lg"
